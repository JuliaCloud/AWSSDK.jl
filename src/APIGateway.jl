...
"""
    ...
    apigateway([::AWSConfig], "POST", "/restapis/{restapi_id}/authorizers", restapi_id=, name=, type=, identitySource=, <keyword arguments>)
...
## `type = "TOKEN" or "COGNITO_USER_POOLS"` -- *Required*
