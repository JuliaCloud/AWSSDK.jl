#==============================================================================#
# CloudSearchDomain.jl
#
# This file is generated from:
# https://github.com/aws/aws-sdk-js/blob/master/apis/cloudsearchdomain-2013-01-01.normal.json
#==============================================================================#
...
"""
    ...
    cloudsearchdomain([::AWSConfig], "GET", "/2013-01-01/search?format=sdk&pretty=true", q=, <keyword arguments>)
...
## `q.parser = "simple", "structured", "lucene" or "dismax"`
...
@inline search(args) = search(default_aws_config(), args)
...
"""
    ...
    cloudsearchdomain([::AWSConfig], "GET", "/2013-01-01/suggest?format=sdk&pretty=true", q=, suggester=, <keyword arguments>)

# Suggest Operation

Retrieves autocomplete suggestions for a partial query string. You can use suggestions enable you to display likely matches before users finish typing. In Amazon CloudSearch, suggestions are based on the contents of a particular text field. When you request suggestions, Amazon CloudSearch finds all of the documents whose values in the suggester field start with the specified query string. The beginning of the field must match the query string to be considered a match.

For more information about configuring suggesters and retrieving suggestions, see [Getting Suggestions](http://docs.aws.amazon.com/cloudsearch/latest/developerguide/getting-suggestions.html) in the *Amazon CloudSearch Developer Guide*.
...
@inline suggest(args) = suggest(default_aws_config(), args)
...
@inline upload_documents(args) = upload_documents(default_aws_config(), args)




end # module CloudSearchDomain
